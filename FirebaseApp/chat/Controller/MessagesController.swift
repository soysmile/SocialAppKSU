...
class MessagesController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableViewSetup(){
        ...
        userTableView.separatorColor = UIColor.black
        userTableView.addSubview(self.refreshControl)
        userTableView.register(UserCell.self, forCellReuseIdentifier: "cellId")
    }
    ...
    //fetch User And Setup Nav Bar Title
